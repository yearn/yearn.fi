        ...
        <div className="space-y-4">
          <div className="space-y-1">
            ...
            <p className="text-xs text-text-secondary">
              Applies site-wide across all vaults. Enso uses this as execution slippage; route price impact is checked
              separately.
            </p>
          </div>
          ...
          <div className="space-y-3">
            <div className="space-y-2">
              ...
              <p className="text-xs text-text-secondary">
                Default is 0.50%. Routes with price impact at or above 5.00% are blocked.
              </p>
