...
function sanitizeSyncResult(result: TLedgerSyncResult): unknown {
  ...
  return {
    ...
    envio: {
      ...
      strategy: result.envio.strategy,
      requests: result.envio.requests,
      presenceRequests: result.envio.presenceRequests,
      batchedRequests: result.envio.batchedRequests,
      continuationRequests: result.envio.continuationRequests,
