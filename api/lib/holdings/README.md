...
- Recognized vault-to-vault rollover transactions can roll basis from a source family into a destination family, including known migrator flows and supported Enso-mediated rollovers on Ethereum mainnet. When source basis cannot be reconstructed, the destination shares stay partial / unknown-basis.
