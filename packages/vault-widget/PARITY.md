...
| Merkle and staking rewards | In progress | Allowlisted Merkl and source-compatible VeYFI/Juiced/OP Boost staking discovery, cumulative-proof calldata with claimable outcome accounting, per-token formatted activity persistence, styled claim rows, shared execution, chain-switch/Safe plans, tests, and a stateful Juiced reward discovery/claim complete; connected-wallet and other live-source visual QA pending |
