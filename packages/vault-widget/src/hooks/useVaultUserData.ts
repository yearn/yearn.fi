...
import { VAULT_V3_ABI } from '@yearn/vault-widget/internal/contracts/abi/vaultV3.abi'
...
import type { VaultUserData } from '@yearn/vault-widget/types'
...
export type { VaultUserData } from '@yearn/vault-widget/types'
