...
import { STAKING_REWARDS_ABI } from '@yearn/vault-widget/internal/contracts/abi/stakingRewards.abi'
import { TOKENIZED_STRATEGY_ABI } from '@yearn/vault-widget/internal/contracts/abi/tokenizedStrategy.abi'
import { VEYFI_GAUGE_ABI } from '@yearn/vault-widget/internal/contracts/abi/veYFIGauge.abi'
