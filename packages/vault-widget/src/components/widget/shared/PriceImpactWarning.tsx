import { Tooltip } from '@yearn/vault-widget/internal/components/shared/Tooltip'
import { IconInfo } from '@yearn/vault-widget/internal/icons/IconInfo'
import { ZAP_SLIPPAGE_HARD_CAP } from '@yearn/vault-widget/internal/utils/slippage'
