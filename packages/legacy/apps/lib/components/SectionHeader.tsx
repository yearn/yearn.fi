  ...
  return (
    <div
      ...
      <div
        ...
        {!!tagline && (
          <p className={'mb-2 hidden font-medium text-lightBlue-500 md:block'}>{tagline}</p>
        )}
        {!!title &&
          (isH1 ? (
            <h1
              className={'text-center text-4xl font-medium leading-tight md:text-left md:text-6xl'}>
              {title}
            </h1>
          ) : (
