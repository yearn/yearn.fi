...
export function VaultDetailsQuickActionsSwitch(): ReactElement {
  return (
    <div
      className={
        'mx-auto flex w-full justify-center space-y-0 md:mx-none md:block md:w-14 md:space-y-2'
      }>
      <p className={'hidden text-base md:inline'}>&nbsp;</p>

      <div
        className={
          'flex size-6 rotate-90 items-center justify-center p-0 md:h-10 md:w-14 md:rotate-0'
        }>
