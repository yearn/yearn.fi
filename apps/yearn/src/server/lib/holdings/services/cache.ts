...
// v12 includes receipt-weighted ETH growth in each compact vault-family series.
const PROTOCOL_RETURN_HISTORY_KEY_PREFIX = 'holdings:protocol-return-history:v12'
