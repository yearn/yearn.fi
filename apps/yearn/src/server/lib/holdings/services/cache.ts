...
// v23 preserves offsetting vault Index contributions using capital weights at each cash flow.
const PROTOCOL_RETURN_HISTORY_KEY_PREFIX = 'holdings:protocol-return-history:v23'
