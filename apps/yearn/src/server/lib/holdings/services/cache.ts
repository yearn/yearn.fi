...
// v24 discards incomplete history cached after shared price ranges lost receipt timestamps.
const PROTOCOL_RETURN_HISTORY_KEY_PREFIX = 'holdings:protocol-return-history:v24'
