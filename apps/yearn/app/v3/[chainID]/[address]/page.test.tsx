...
describe('v3 vault detail page visibility', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  ...
  it('fails open when vault metadata is unavailable', async () => {
    const metadata = { title: 'Yearn Vault' }
    mockFetchVaultMetadataSnapshot.mockResolvedValue(null)
    mockBuildVaultMetadataFromInput.mockReturnValue(metadata)
