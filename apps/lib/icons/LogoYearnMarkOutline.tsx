...
export function LogoYearnMarkOutline(props: React.SVGProps<SVGSVGElement> & { color?: string }): ReactElement {
  ...
  return (
    ...
    >
      <defs>
        <clipPath id={'logo-mark-outline-clip'}>
      ...
      <g clipPath={'url(#logo-mark-outline-clip)'} transform={'translate(6 6) scale(0.95)'}>
        <path
          fill={'none'}
          stroke={color}
          strokeWidth={12}
