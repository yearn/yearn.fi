...
export function VaultsBanner(): ReactElement | null {
  ...
  return (
    <div
      className={
        'relative flex w-full items-stretch overflow-hidden rounded-[16px] bg-linear-to-b from-blue-800/50 to-blue-900/10 shadow-[inset_0_0_0_1px_rgba(255,255,255,0.1)]'
      }
    >
      <div className={'flex flex-1 flex-col justify-center gap-4 p-8'}>
        ...
        <div className={'flex flex-col gap-4'}>
          <p className={' max-w-[55ch] border-t border-white/10 pt-4 text-[18px] text-steel-gray-500 md:max-w-full '}>
      ...
      >
        <div className={'relative size-48'}>
          <Image src={'/landing/safe.png'} alt={'Yearn Vaults Safe'} fill className={'object-contain'} priority />
        </div>
      </div>
    </div>
  )
