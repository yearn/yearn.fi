import { MultiSelectDropdown, type TMultiSelectOptionProps } from '@lib/components/MultiSelectDropdown'
...
const ChainLogosStack: React.FC<{ selectedOptions: TMultiSelectOptionProps[] }> = ({ selectedOptions }) => (
...
export const ChainFilterDropdown: React.FC<TChainFilterDropdownProps> = ({
  ...
  return (
    <div className={className}>
      <MultiSelectDropdown
        customRender={<ChainLogosStack selectedOptions={selectedOptions} />}
