export const VAULT_MIGRATOR_ABI = [
	{
		inputs: [
			...
			{internalType: 'contract IChiToken', name: '_chiToken', type: 'address'}
		],
	...
	{
		anonymous: false,
		inputs: [{indexed: false, internalType: 'contract IChiToken', name: '_chiToken', type: 'address'}],
		name: 'ChiTokenSet',
		type: 'event'
	},
	{
		...
		inputs: [
			...
			{indexed: false, internalType: 'address', name: '_subsidizor', type: 'address'}
		],
		name: 'Subsidized',
		type: 'event'
	},
	...
	{
		inputs: [{internalType: 'contract IChiToken', name: '_chiToken', type: 'address'}],
		name: 'setChiToken',
		outputs: [],
		stateMutability: 'nonpayable',
		type: 'function'
