...
import {STAKING_REWARDS_SUPPORTED_CHAINS} from '@vaults/constants';
...
export const StakingRewardsContextApp = memo(function StakingRewardsContextApp({children}: {children: ReactElement}): ReactElement {
	...
	const stakingRewardsFetcher = useCallback(async (): Promise<TStakingRewards[]> => {
		...
		// const STAKING_REWARDS_REGISTRY_ADDRESS = ''; // TODO: update and move to constants once is available
		...
		const stakingRewardsAddresses = [toAddress('0x1eC8BaAB7DBd6f5a02EfcAb711e765bF796d091c')];
