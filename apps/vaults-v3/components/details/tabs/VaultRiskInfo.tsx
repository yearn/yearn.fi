    ...
    <div className={'grid grid-cols-1 gap-4 p-4 md:grid-cols-12 md:gap-10 md:p-8'}>
      <div className={'col-span-12 mt-6 w-full md:mt-0'}>
        <div className={'flex flex-col mb-4 md:mb-10'}>
          <div className={cl('grid w-1/3 grid-cols-4 items-center gap-6')}>
            <div className={'col-span-2'}>
              <b className={'block text-neutral-900'}>{'Overall Risk Score'}</b>
              {/* <p className={'mt-1 block w-3/4 text-sm text-neutral-900/40'}>
                {
          ...
          <div className={cl('', hasRiskScore ? '' : 'hidden')}>
            <div className={cl('grid w-1/3 grid-cols-4 items-center gap-6')}>
              <div className={'col-span-2'}>
                <p>{'Review'}</p>
