		...
		<CardTransactorContextApp
			...
			<div className={cl('mx-auto w-full bg-neutral-200 p-4 md:p-6', className)}>
				...
				<div className={'w-full pb-8'}>
					<p className={'text-sm text-neutral-600'}>{'Swap any token within the yBal ecosystem for any other. Maybe you want to swap for a higher yield, or maybe you just like swapping. It’s ok, we don’t judge.'}</p>
				</div>
				<CardZap />
			</div>
		</CardTransactorContextApp>
