...
export function useAllowances(): [TDict<bigint>, () => void] {
	...
	const zapAddress = useMemo((): TAddress => ZAP_YEARN_YBAL_ADDRESS, []);
	...
	return useMemo((): [TDict<bigint>, () => void] => {
		...
		return [
			{
				[allowanceKey(1, BAL_TOKEN_ADDRESS, ZAP_YEARN_YBAL_ADDRESS, toAddress(address))]: decodeAsBigInt(data[0]),
				[allowanceKey(1, WETH_TOKEN_ADDRESS, ZAP_YEARN_YBAL_ADDRESS, toAddress(address))]: decodeAsBigInt(data[1]),
				[allowanceKey(1, BALWETH_TOKEN_ADDRESS, ZAP_YEARN_YBAL_ADDRESS, toAddress(address))]: decodeAsBigInt(data[2]),
				[allowanceKey(1, YBAL_TOKEN_ADDRESS, ZAP_YEARN_YBAL_ADDRESS, toAddress(address))]: decodeAsBigInt(data[3]),
				[allowanceKey(1, STYBAL_TOKEN_ADDRESS, ZAP_YEARN_YBAL_ADDRESS, toAddress(address))]: decodeAsBigInt(data[4]),
				[allowanceKey(1, LPYBAL_TOKEN_ADDRESS, ZAP_YEARN_YBAL_ADDRESS, toAddress(address))]: decodeAsBigInt(data[5])
			}, refetch
		];
